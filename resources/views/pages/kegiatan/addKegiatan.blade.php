...
@section('content')
   ...
   <form action="{{ route('auth.schoolEvent.store') }}" method="post" enctype="multipart/form-data">
      ...
      <label for="deskripsi">
         ...
         <input value="{{ old('deskripsi') }}" type="text" name="deskripsi"
      ...
      <label for="ketua_panitia">
         ...
         <input value="{{ old('ketua_panitia') }}" type="text" name="ketua_panitia"
      ...
      <label for="penanggung_jawab">
         ...
         <input value="{{ old('penanggung_jawab') }}" type="text" name="penanggung_jawab"
      ...
      <label for="jumlah_peserta">
         ...
         <input value="{{ old('jumlah_peserta') }}" type="number" name="jumlah_peserta"
      ...
      <label for="tanggal_mulai">
         ...
         <input value="{{ old('tanggal_mulai') }}" type="date" name="tanggal_mulai"
      ...
      <label for="waktu_mulai">
         ...
         <input value="{{ old('waktu_mulai') }}" type="time" name="waktu_mulai"
      ...
      <label for="tanggal_selesai">
         ...
         <input value="{{ old('tanggal_selesai') }}" type="date" name="tanggal_selesai"
