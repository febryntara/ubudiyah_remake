...
@section('content')
    ...
    <form class="grid grid-cols-2 gap-y-2 gap-x-3" method="post"
        ...
        <div class="col-span-2 ">
            @if ($user->image)
                <img class="w-[400px] h-[250px] object-cover img-preview" src="{{ asset('storage/' . $user->image->src) }}"
                    alt="default profile">
            @else
                <img src="https://i.pinimg.com/474x/97/7f/e7/977fe798cf2c3a037e7aa9af6ce4b9d1.jpg" class="img-preview"
                    alt="">
            @endif
            {{-- @if ($user->image)
                <img class="w-[400px] h-[250px] object-cover img-preview img-fluid"
                    src="{{ asset('storage/' . $user->image->src) }}" alt="default profile">
            @else
                <img class="w-[400px] h-[250px] object-cover img-preview img-fluid">
            @endif --}}
            ...
            <input name="image"
                ...
                aria-describedby="file_input_help" id="file_input" type="file" onchange="previewImage()">
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">PNG, JPG or JPEG .</p>
            {{-- SCRIPT JS FOR PREVIEW IMAGE --}}
            <script>
            ...
            <div>
                ...
                <select id="role_id" name="role_id"
                    ...
                    @foreach ($user_roles as $ur => $data)
                        <option value="{{ old('role_id') ?? $data->id }}"
                            {{ $user->role_id == $data->id ? 'selected' : null }}>
        ...
        <div class="">
            ...
            @if ($user->role_id == 3)
                ...
                <div>
                    <label for="mapel_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mapel
                        yang
                        Diampu</label>
                    <select id="kelas" name="kelas"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="">
            <div>
                <label for="email"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Demail</label>
            ...
            <div>
                <label for="kontak"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Kontak</label>
